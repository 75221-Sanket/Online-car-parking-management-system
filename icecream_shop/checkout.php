    ...
    if (isset($_POST['place_order'])) {
      ...
      if (isset($_GET['get_id'])) {
          ...
          if ($get_product->rowCount() > 0) {
            ...
            $success_msg[] = 'somthing went wrong';
          }
...
<head>
    ...
    <title>The Creamery House - checkout page</title>
       ...
       <div class="row">
             ...
             <div class="flex">
                 <div class="box">
                     ...
                     <div class="input-field">
                         ...
                         <input type="email" name="email" required maxlength="50" placeholder="enter your number" class="input">
                     </div>
                     <div class="input-field">
                 ...
                 <div class="box">
                     ...
                     <div class="input-field">
                         ...
                         <input type="number" name="pin" required maxlength="6"  min = "0"placeholder="e.g 416307 " class="input">
                     </div>
                 </div>
             </div>
         ...
         <div class="summary"> 
             ...
             <div class="box-container">
                ...
                ?> 
                <div class="flex">
                    <img src="uploaded files/<?= $fetch_get['image']; ?> " class="image">
                    <div>
                ...
                <div class="flex">
                    ...
                    <div>
                        ...
                        <p class="price">Rs<?= $fetch_products['price']; ?> x <?= $fetch_cart['qty']; ?></p>
                    </div>
                </div>
                <?php
                          }
