 ...
 if (isset($_COOKIE['seller_id'])) {
  ...
  if (isset($_POST['update'])) {
     ...
     $name = $_POST['name'];
      ...
      $price = filter_var($price, FILTER_SANITIZE_STRING);
       ...
       $image_folder = '../uploaded files/'.$image;
  ...
  if (isset($_POST['delete_image'])) {
      ...
      if($fetch_delete_image['image'] != ''){
           unlink('../uploaded files/'.$fetch_delete_image['image']);
      }
...
<html>
    <head>
        ...
        <title>The Creamery House - Admin Dashboard page</title>
           ...
           <div class="box-container">
               ...
               <div class="form-container">
                   <form action="" method="post" enctype="multipart/form-data" class="register">
                     ...
                     <div class="flex-btn">
                        <input type="submit" name="update" value="save post" class="btn">
                        <input type="submit" name="delete_product" value="delete post" class="btn">
                     </div>
                 </form>
               </div>
               <?php 
