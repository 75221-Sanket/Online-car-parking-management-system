...
<html>
	<head>
		...
		<title>The Creamery House - Admin Add Products page</title>
                    ...
                    <div class="input-field">
                     ...
                     <div class="input-field">
                       ...
                       <div class="input-field">
                         ...
                         <textarea name="description" name="name" required maxlength="1000" placeholder="add product detail"  class="box"></textarea>
                     </div>
                        <div class="input-field">
