...
<head>
	...
	<title>The Creamery House - home page</title>
...
<body>
    ...
    <div class="service">
       <div class="box-container">
         <!-- service item box-->
           ...
           <div class="box">
              <div class="icon">
                 <div class="icon-box">
                     <img src="image/services (4).png" class="img1">
                     <img src="image/services (5).png" class="img2">
                 </div> 
              </div> 
              <div class="detail">
                 <h4>support</h4> 
     ...
     <div class="categories">
         ...
         <div class="box-container">
            <div class="box">
              <img src="image/categories 0.jpg">
     ...
     <img src ="image/menu-banner1.jpg" class="menu-banner">
     <div class="taste">
         <div class="heading">
            <span>taste</span>
            <h1>by any ice cream @ get one free</h1>
             <img src="image/separator-img1.jpg">
         </div>
         <div class="box-container">
            <div class="box">
     ...
     <div class="ice-container">
         ...
         <div class="detail">
           <h1>Ice cream is cheaper than <br> therpy for stress</h1> 
           <p>It is important that the patient is the patient, the patient is followed by the patient, <br> but the time is too short.</p> 
           <a href="menu.php"class="btn">shop now</a>
         </div>
     </div>
            ...
            <div class="box-container">
                <div class="box">
                    ...
                    <div class="detail">
                       ...
                       <p>The customer himself, the customer will be able to pursue the adipiscing of the company. The matter of pain will not be said, but I will explain, born of labor because of desire</p> 
                    </div>
                </div>
                 <div class="box">
  ...
  <!--usage section end-->
   ...
   <div class="detail">
       ...
       <p>It is very important to take care of the patient, the patient will be followed by the patient, <br> but at the same time they occur as a result of some great work and pain.</p>
       <a href="menu.php" class="btn">shop now</a>
     </div>
 </div>
       <!--pride section end-->
