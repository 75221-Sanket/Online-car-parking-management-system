<header>
	<div class="logo">
		<img src="../image/logo14.png" width="150">
	</div>
	<div class="right">
       <div class="bx bxs-user" id="user-btn"></div>
        <div class="toggle-btn"><i class="bx bx-menu"></i>
    </div>
  </div>
    ...
    ?>
    <div class="profile">
    	<img src="../uploaded files/<?= $fetch_profile['image'];?>" class="logo-img" width="100">
...
<div class="sidebar-container">
    ...
    ?>
    <div class="profile">
    	<img src="../uploaded files/<?= $fetch_profile['image'];?>" class="logo-img.jpg" width="100">
